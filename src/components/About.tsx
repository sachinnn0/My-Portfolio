    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Sachin Vishwakarma - I love creating websites and have a great eye for good design. Welcome to my corner of the
          digital world!
        </Paragraph>
        <Paragraph className=" mt-4">
          Since the early days of my journey, I&apos;ve been captivated by the
          art of crafting exceptional digital experiences.As a frontend developer, I love turning designs into interactive and user-friendly websites. My goal is to build beautiful, responsive interfaces that not only look great but also work perfectly.
        </Paragraph>
